...
@Component({
  selector: 'app-overlay-lock',
  templateUrl: './overlay-lock.component.html',
  styleUrls: ['./overlay-lock.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class OverlayLockComponent implements OnInit, OnDestroy {
  ...
  private componentNameSubscriber: any;
   ...
   * @param {SlidingPanelService} _overlayLockService
  ...
  constructor(
    ...
    private _overlayLockService: OverlayLockService,
  ...
  ngOnInit(): void { 
    ...
    this.componentNameSubscriber = this._overlayLockService.componentNameChange.subscribe(
      res => {
        if(res)
        this.componentName.emit(res)
      }
      );
    ...
    this._overlayLockService.register(this.name, this);
  ...
  ngOnDestroy(): void {
    ...
    this._overlayLockService.unregister(this.name);

    // Unsubscribe from all subscriptions
    this._unsubscribeAll.next();
    this._unsubscribeAll.complete();
    this.componentNameSubscriber && this.componentNameSubscriber.unsubscribe()
  }
  ...
  private _showSidebar(): void {
    ...
    this._renderer.setStyle(this._elementRef.nativeElement, 'max-width', '100%');
